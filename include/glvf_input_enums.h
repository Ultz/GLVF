...
enum GLVFAxisKind {
    GLVF_AXIS_KIND_GAMEPAD_TRIGGER,
    GLVF_AXIS_KIND_GAMEPAD_THUMBSTICK,
    GLVF_AXIS_KIND_GAMEPAD_DPAD,
    GLVF_AXIS_KIND_JOYSTICK,
    GLVF_AXIS_KIND_JOYSTICK_HAT,
    GLVF_AXIS_KIND_VIEW_SIZE,
    GLVF_AXIS_KIND_VIEW_FRAMEBUFFER_SIZE,
    GLVF_AXIS_KIND_VIEW_POSITION,
    GLVF_AXIS_KIND_MOUSE_POSITION,
    GLVF_AXIS_KIND_MOUSE_SCROLL_OFFSET,
    GLVF_AXIS_KIND_FORCE_32_BIT = 2147483647
};
